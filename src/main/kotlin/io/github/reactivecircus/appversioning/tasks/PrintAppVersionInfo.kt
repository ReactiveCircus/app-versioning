...
abstract class PrintAppVersionInfo : DefaultTask() {
    ...
    @TaskAction
    fun print() {
        if (versionCodeFile.isPresent && versionNameFile.isPresent) {
            logger.quiet(
                """
            ...
            logger.warn("No app version info (versionCode and versionName) generated by the Android App Versioning plugin for the \"${buildVariantName.get()}\" variant of project \":${projectName.get()}\" is available.")
        }
    }
